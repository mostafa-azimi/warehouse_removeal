...
export async function GET(request: NextRequest) {
  try {
    console.log('ShipHero warehouses API route called (GET)')
    ...
    return await fetchWarehouses(accessToken)
  } catch (error: any) {
...
export async function POST(request: NextRequest) {
  try {
    console.log('ShipHero warehouses API route called (POST)')
...
async function fetchWarehouses(accessToken: string) {
  try {
